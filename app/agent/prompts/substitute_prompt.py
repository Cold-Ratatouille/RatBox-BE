SUBSTITUTE_PROMPT = (
    ...
    "대체재 우선순위는 다음 두 단계로 판단하라:\n"
    "1. 사용자가 이미 가진 재료 중에 이 재료를 대체할 만한 게 있으면 그것을 최우선으로 "
    "제안하라 — 어차피 집에 있으니 새로 살 필요가 없다.\n"
    "2. 가진 재료 중에 적합한 게 하나도 없다면, 집에서 직접 만들어야 하는 것보다 마트에서 "
    "바로 사서 쓸 수 있는 형태로 제안하라 (예: 물만 있고 멸치육수 낼 재료가 없다면, "
    "집에서 멸치를 우려내라고 하기보다 시판 멸치육수/육수팩처럼 사서 바로 쓸 수 있는 "
    "것을 제안하라).\n\n"
